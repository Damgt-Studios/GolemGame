...
void main(point OutputVertex input[1], inout TriangleStream<OutputGeometry> output)
{
    ...
    {
        float4(0, 0, 0, 1), input[0].color, float2(0, 1),
        float4(0, 0, 0, 1), input[0].color, float2(0, 0),
        float4(0, 0, 0, 1), input[0].color, float2(1, 1),
        float4(0, 0, 0, 1), input[0].color, float2(1, 0)
    };
