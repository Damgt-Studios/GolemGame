...
//			}
//
//			//Trigger* fb = GameUtilities::AddTriggerFromModelFile("files/models/Fireball.mesh", "files/textures/Fireball.mat", XMFLOAT3(0, 0, 0), XMFLOAT3(0.05f, 0.05f, 0.05f), XMFLOAT3(0, 0, 0));
//			//GameUtilities::AddGameObject(fb);
//
//			ADUI::UIMessage eventUIMessage;
//			eventUIMessage.targetID = 1;
//			eventUIMessage.externalMsg = true;
//			eventUIMessage.commandID = 0;
//			//MessageTrigger* fb = GameUtilities::AddMessageTrigger(eventUIMessage, XMFLOAT3(10, 10, 10), XMFLOAT3(1, 1, 1), XMFLOAT3(0, 0, 0));
//			//GameUtilities::AddGameObject(fb);
//
//
